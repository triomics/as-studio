		...
		<div id="soc-block" class="social-icon-btn">
			<button class="btn soc-btn">Я в соц. сетях
				<ul class="soc-icons">
					...
					<li><a href="#" class="as-facebook"></a></li>
					<li><a href="#" class="as-youtube"></a></li>
					<li><a href="#" class="as-linkedin"></a></li>
					<li><a href="#" class="as-instagram1"></a></li>		
				</ul>
			</button>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-offset-4 col-md-6">
			<div id="copyright" class="block copyright">
				...
				<p>Сайт разработан студией дизайна АS</p>
			</div>
		</div>
